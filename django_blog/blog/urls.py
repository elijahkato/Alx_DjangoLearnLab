...
from .views import profile_view,  add_comment, edit_comment, delete_comment
...
urlpatterns = [
    ...
    path('comment/<int:comment_id>/edit/', edit_comment, name='edit-comment'),  # Edit existing comment
    path('comment/<int:comment_id>/delete/', delete_comment, name='delete-comment'),  # Delete comment
]
